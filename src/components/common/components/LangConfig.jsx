    ...
    translation: {
      ...
      itemsArray: {
        0: {
          ...
          type: "Jouets",
          details:
            "Une voiture électrique passionnante pour les enfants à conduire avec style, offrant des heures de divertissement et de plaisir.",
        },
        1: {
          title: "Appareil photo CANON EOS DSLR",
          type: "Technologie",
          details:
            "Capturez des photos et des vidéos époustouflantes avec cet appareil photo reflex numérique Canon de qualité professionnelle, parfait pour les passionnés de photographie.",
        },
        2: {
          title: "Nourriture sèche pour chiens de race",
          type: "Général",
          details:
            "Nourriture sèche nutritive pour chiens pour garder votre ami à fourrure en bonne santé et heureux, fabriquée avec des ingrédients de haute qualité.",
        },
        3: {
          title: "Ordinateur portable de jeu ASUS FHD",
          type: "Technologie",
          details:
            "Découvrez des performances de jeu de haute qualité avec cet ordinateur portable de jeu ASUS FHD, doté de graphismes avancés et d'un gameplay fluide.",
        },
        4: {
          title: "Ensemble de produits Curology",
          type: "Général",
          details:
            "Un ensemble complet de soins de la peau par Curology pour nettoyer, hydrater et protéger votre peau, la laissant douce et éclatante.",
        },
        5: {
        ...
        6: {
          ...
          type: "Vêtements",
          details:
            "Restez élégant et au chaud avec cette veste en satin matelassée, parfaite pour ajouter une touche tendance à votre tenue.",
        },
        7: {
          title: "Petite étagère",
          type: "Général",
          details:
            "Organisez vos livres et objets décoratifs avec cette petite étagère, conçue pour s'adapter aux espaces compacts.",
        },
        8: {
          title: "Refroidisseur de CPU liquide RGB",
          type: "Technologie",
          details:
            "Gardez votre CPU au frais et en bon état de fonctionnement avec le refroidisseur de CPU liquide RGB, doté d'une pompe haute performance et d'un éclairage RGB personnalisable.",
        },
        9: {
          title: "Sac de voyage Gucci",
          type: "Vêtements",
          details:
            "Voyagez avec style avec le sac de voyage Gucci, fabriqué à partir de matériaux de qualité supérieure et conçu pour la durabilité et le luxe.",
        },
        10: {
          title: "Le manteau du Nord",
          type: "Vêtements",
          details:
            "Restez au chaud et à la mode avec le manteau du Nord, doté d'une construction durable et d'un design intemporel.",
        },
        11: {
        ...
        12: {
          ...
          type: "Technologie",
          details:
            "Tapez rapidement et avec précision avec le clavier filaire AK-900, doté d'une construction durable et d'un design ergonomique.",
        },
        13: {
        ...
        14: {
          ...
          type: "Vêtements",
          details:
            "Détendez-vous confortablement avec la chaise de confort série S, dotée d'un design ergonomique et d'un rembourrage moelleux pour de longues heures d'assise.",
        },
        15: {
          title: "JBL Boombox 2",
          type: "Nouveauté",
          details:
            "Profitez d'un son puissant avec le JBL Boombox 2, doté d'un design robuste et d'une longue durée de vie de la batterie pour une écoute toute la journée.",
        },
        16: {
          title: "Parfum",
          type: "Nouveauté",
        ...
        17: {
          ...
          type: "Nouveauté",
          details:
            "Ce téléphone dispose d'un grand écran, d'un processeur puissant et d'une longue durée de vie de la batterie, parfait pour le travail et les loisirs.",
        },
        10: {
          title: "PlayStation 5",
          type: "Nouveauté",
        ...
        19: {
          ...
          type: "Nouveauté",
          details:
            "Qualité sonore incroyable avec le haut-parleur sans fil Amazon.",
        },
        20: {
          title: "Collections pour femmes",
          type: "Nouveauté",
          details:
            "Les collections pour femmes sont présentées, vous offrant une autre ambiance, et vous pouvez trouver les meilleures collections ici.",
        },
        21: {
      ...
      signUpPage: {
        ...
        confirmPassword: "Confirmer le mot de passe",
        passwordRequirements:
          "Le mot de passe doit comporter au moins 8 caractères, inclure un chiffre et au moins une lettre majuscule.",
        createAccount: "Créer un compte",
      ...
      featured: {
        ...
        WomenCollections: {
          title: "Collections pour femmes",
          description:
            "Collections pour femmes présentées qui vous donnent une autre ambiance.",
        },
        speakers: {
          title: "Haut-parleurs",
