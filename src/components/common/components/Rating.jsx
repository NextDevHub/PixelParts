...
const RatingComp = ({ text, variant, item }) => {
  ...
  const [ratingValue, setRatingValue] = useState(0); // Use state for rating value
  ...
  const handleClose = () => {
    setOpen(false);
    setRatingValue(0); // Reset rating when closing
    setReviewText(""); // Reset review text when closing
  };
  ...
  const handleRatingChange = (event, newValue) => {
    setRatingValue(newValue); // Update rating state
  };
      ...
      >
        ...
        <Box display="flex" justifyContent="flex-end" p={2}>
          ...
          <Button
            ...
            disabled={!reviewText || !ratingValue}
          >
            Submit
          </Button>
        </Box>
